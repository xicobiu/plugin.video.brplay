...
def validate_login(credentials, do_request=True):
    ...
    if PLATFORM == 'PCTV':
        ...
        url = 'https://www.clarotvmais.com.br/AGL/1.1/R/ENG/%7Bplatform%7D/ALL/NET/USER/SESSIONS'.format(platform=PLATFORM)
    else:
        device_id = credentials['deviceId']
        header['User_Agent'] = 'NETNow/10.10.06 (br.com.netcombo.now.iphone; build:4; iOS 14.0.1) Alamofire/4.5.1'
        url = 'https://www.clarotvmais.com.br/AGL/1.1/R/ENG/%7Bplatform%7D/ALL/NET/USER/SESSIONS?accountDeviceIdType=DEVICEID&accountDeviceId={deviceId}'.format(platform=PLATFORM, deviceId=device_id)
